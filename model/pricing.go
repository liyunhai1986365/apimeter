...
// loadPricingAdvancedCustomConfigs follows the lock order updatePricingLock ->
// channelSyncLock and returns immutable config snapshots from the channel cache.
