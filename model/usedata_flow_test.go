...
func TestGetFlowQuotaDataUsesQuotaDataRoleSpecificDimensions(t *testing.T) {
	...
	rootRows, err := GetFlowQuotaData(900, 2000, "", 0, common.RoleRootUser, nil)
	...
	adminRows, err := GetFlowQuotaData(900, 2000, "alice", 0, common.RoleAdminUser, nil)
	require.NoError(t, err)
	...
	selfRows, err := GetFlowQuotaData(900, 2000, "", 1, common.RoleCommonUser, nil)
	require.NoError(t, err)
...
func TestGetSelfTokenQuotaDataGroupsOnlyAuthenticatedUserTokens(t *testing.T) {
	...
	rows, err := GetSelfTokenQuotaData(900, 1200, 1, nil)
	require.NoError(t, err)
