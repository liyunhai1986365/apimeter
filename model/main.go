...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&CustomOAuthProvider{},
		&UserOAuthBinding{},
		&OpenMosaicSSOTokenBinding{},
		&OpenMosaicSSOAuthorizationCode{},
		&PerfMetric{},
		&Agent{},
		&AgentDomain{},
		&AgentUser{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&RetryRouteEvent{}, "RetryRouteEvent"},
		...
		{&OpenMosaicSSOTokenBinding{}, "OpenMosaicSSOTokenBinding"},
		{&OpenMosaicSSOAuthorizationCode{}, "OpenMosaicSSOAuthorizationCode"},
...
` + "`discount_description`" + ` varchar(64) DEFAULT '',
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "discount_description", DDL: "`discount_description` varchar(64) DEFAULT ''"},
