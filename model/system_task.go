...
const (
	...
	SystemTaskTypeMonthlyBilling   = "monthly_billing_statement"
	SystemTaskTypeTaskImageCleanup = "task_image_base64_cleanup"
)
...
// CountActiveSystemInstances returns the number of active system task runner instances
func CountActiveSystemInstances(currentTimestamp int64) (int64, error) {
	var count int64
