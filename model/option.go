...
func InitOptionMap() {
	...
	common.OptionMap["GoCaptchaCheckEnabled"] = strconv.FormatBool(common.GoCaptchaCheckEnabled)
	...
	common.OptionMap["GroupDisplayConfig"] = setting.GroupDisplayConfig2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "GoCaptchaCheckEnabled":
			common.GoCaptchaCheckEnabled = boolValue
	...
	case "GroupDisplayConfig":
		err = setting.UpdateGroupDisplayConfigByJSONString(value)
	...
	case "AffiliateTopUpRewardRatio":
	...
	case "AutomaticRetryPolicyRules":
		err = operation_setting.AutomaticRetryPolicyRulesFromString(value)
