...
const AuthenticatedUserSubscriptionIndexRoute =
  AuthenticatedUserSubscriptionIndexRouteImport.update({
...
const AuthenticatedModelBillingIndexRoute =
  AuthenticatedModelBillingIndexRouteImport.update({
    id: '/model-billing/',
    path: '/model-billing/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
const AuthenticatedBillingSectionRoute =
  AuthenticatedBillingSectionRouteImport.update({
    id: '/billing/$section',
...
export interface FileRoutesByFullPath {
  ...
  '/billing/$section': typeof AuthenticatedBillingSectionRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/billing/$section': typeof AuthenticatedBillingSectionRoute
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/subscription/'
    | '/(auth)/user/reset'
    | '/_authenticated/billing/$section'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/user-subscription/': {
      id: '/_authenticated/user-subscription/'
      path: '/user-subscription'
      fullPath: '/user-subscription/'
      preLoaderRoute: typeof AuthenticatedUserSubscriptionIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/usage-logs/': {
    ...
    '/_authenticated/model-billing/': {
      id: '/_authenticated/model-billing/'
      path: '/model-billing'
      fullPath: '/model-billing/'
      preLoaderRoute: typeof AuthenticatedModelBillingIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/keys/': {
    ...
    '/_authenticated/billing/$section': {
      id: '/_authenticated/billing/$section'
      path: '/billing/$section'
      fullPath: '/billing/$section'
      preLoaderRoute: typeof AuthenticatedBillingSectionRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/(auth)/user/reset': {
      id: '/(auth)/user/reset'
