...
const defaultOperationsSettings: OperationsSettings = {
  ...
  'monitor_setting.channel_auto_operation_enabled': false,
  'monitor_setting.channel_auto_operation_threshold': 3,
  'monitor_setting.channel_auto_operation_window_minutes': 10,
  'monitor_setting.channel_auto_operation_min_requests': 5,
  ...
  'webhook_setting.model_error_min_requests': 5,
  'webhook_setting.model_error_rate': 50,
  'webhook_setting.channel_test_check_enabled': true,
  'webhook_setting.channel_test_window_minutes': 60,
  SMTPServer: '',
  SMTPPort: '',
  SMTPAccount: '',
  SMTPFrom: '',
