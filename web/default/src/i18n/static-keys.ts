...
export const STATIC_I18N_KEYS = [
  ...
  'What is the difference between the two partner paths?',
  ...
  'When can I use or withdraw my rewards?',
  ...
  'Can brand partners set their own prices?',
  ...
  'Do I need to maintain upstream model channels?',
  ...
  'OpenMosaic site URL',
  'AI Creation authorization response is incomplete.',
  'AI Creation authorization failed.',
  'OpenMosaic site URL is not configured.',
  'Securely entering AI Creation...',
  ...
  'View CLI docs',
  'Browse Agent tools',
  'APIMeter CLI interactive configuration screen',
  'Guardrails',
  'Observability',
  'Budgets',
  'Load Balancing',
  ...
  'Model sort order saved',
  'Failed to save model sort order',
  'Enabled Status',
  'Duration Settings',
  'Duration Unit',
  'Custom Seconds',
  ...
  'Billing center',
  'Billing overview',
  'Review current usage tokens, discounts, and settlement amount',
  'Review daily statements, usage billing, and transaction ledger',
  'Review daily statement balances and matched transactions',
  'Monthly statements',
  'Review monthly model usage, group pricing, and settlement',
  'Usage billing',
  'Transaction ledger',
  'Review top-ups, usage, refunds, and adjustments',
  'Personal Settings',
