...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		agentSelfRoute.Use(middleware.AgentOwnerAuth())
		{
			...
			agentSelfRoute.POST("/domains/batch", controller.AgentCreateDomains)
		...
		agentAdminRoute.Use(middleware.AdminAuth())
		{
			...
			agentAdminRoute.POST("/:id/domains/batch", controller.AgentCreateDomains)
		...
		taskRoute := apiRouter.Group("/task")
		{
			...
			taskRoute.GET("/self/:task_id", middleware.UserAuth(), middleware.WorkspaceAccountScope(), controller.GetUserTaskDetail)
			taskRoute.GET("/", middleware.AdminAuth(), controller.GetAllTask)
			taskRoute.GET("/:task_id", middleware.AdminAuth(), controller.GetTaskDetail)
		}
