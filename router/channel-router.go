...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/operation_records", permission: authz.ChannelRead, handler: controller.GetChannelOperationRecords},
	{method: http.MethodGet, path: "/filter-options", permission: authz.ChannelRead, handler: controller.GetChannelFilterOptions},
	{method: http.MethodGet, path: "/groups", permission: authz.ChannelRead, handler: controller.GetChannelGroups},
	{method: http.MethodGet, path: "/protocol_profiles", permission: authz.ChannelRead, handler: controller.GetConfigurableProtocolProfiles},
	...
	{method: http.MethodPost, path: "/:id/retry_policy_rules", permission: authz.ChannelSensitiveWrite, handler: controller.AppendChannelRetryPolicyRule},
	...
	{method: http.MethodDelete, path: "/:id/models", permission: authz.ChannelSensitiveWrite, handler: controller.RemoveChannelModel},
	...
	{method: http.MethodPost, path: "/batch/groups", permission: authz.ChannelWrite, handler: controller.BatchSetChannelGroups},
