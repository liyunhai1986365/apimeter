		...
		if ok {
			...
			if shouldSelectChannel {
				...
				if model.IsUserOwnedProviderGroup(channelGroup) && !hasGroupPolicyChain {
					...
					selectGroup = channelGroup
					common.SetContextKey(c, constant.ContextKeyTokenBillingSource, service.BillingSourceUserOwnedProvider)
				}
...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.NewAPIError {
	...
	common.SetContextKey(c, constant.ContextKeyChannelRatio, channelRatio)
	...
	common.SetContextKey(c, constant.ContextKeyChannelRetryEnabled, channel.IsRetryEnabled())
