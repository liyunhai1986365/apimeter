...
| `REQUEST_LOG_STORAGE` | 请求/响应排障日志存储后端，仅支持 `openobserve` | `openobserve` |
| `REQUEST_LOG_OPENOBSERVE_ENDPOINT` | OpenObserve 地址，开启请求日志时必填 | - |
...
📖 **请求日志存储：** [docs/request-log-storage.md](docs/request-log-storage.md)
